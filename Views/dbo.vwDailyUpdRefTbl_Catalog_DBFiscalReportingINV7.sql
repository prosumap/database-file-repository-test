...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vwDailyUpdRefTbl_Catalog_DBFiscalReportingINV7]
AS
SELECT        dbo.RefTbl_Catalog.OFFER_ID, dbo.RefTbl_Catalog.DESCRIPTION, dbo.RefTbl_Catalog.ANTICIPATED_DROP_DATE, dbo.RefTbl_Catalog.ANTICIPATED_END_DATE, 
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwDailyUpdRefTbl_Catalog_DBFiscalReportingINV7', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vwDailyUpdRefTbl_Catalog_DBFiscalReportingINV7', NULL, NULL
GO
