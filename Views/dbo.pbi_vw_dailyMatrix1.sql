...
CREATE view  [dbo].[pbi_vw_dailyMatrix1] 
as
...
left outer join  mktbl_dailyflash1 as d on c.[Date]=d.[date] 
  where --c.[date]=31 
--  c.MonthDesc='Sep'
--  and
   c.[YEAR]=2020
...
--	c.[MonthNo],c.[MonthDesc],	c.[Qtr],c.[Year],c.[Season of Year],c.[YYYYWK]	
 ...
 from [dbo].[RefTbl_Calendar] as c
left outer join  budgetmatrix1 as d on c.[Date]=d.[date] 
  where --c.[date]=31 
--  c.MonthDesc='Sep'
--  and
   c.[YEAR]=2020
...
left outer join  mktbl_dailyflash1 as d on c.[lastyeardate]=d.[date] 
  where --c.[date]=31 
--  c.MonthDesc='Sep'
--  and
   c.[YEAR]=2020 
