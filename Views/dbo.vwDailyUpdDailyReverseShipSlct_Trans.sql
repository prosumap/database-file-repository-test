...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vwDailyUpdDailyReverseShipSlct_Trans]
AS
SELECT        dbo.MkTbl_Trans.ItemTransBP, dbo.MkTbl_Trans.OhId, dbo.MkTbl_Trans.SkuId, dbo.MkTbl_Trans.DSeq, dbo.MkTbl_Trans.Type, dbo.MkTbl_Trans.Cdatedt, dbo.MkTbl_Trans.ItemCatId, dbo.MkTbl_Trans.OdNpriceDD AS AUR, 
                         ...
                         dbo.RefTbl_Calendar.[Season of Year], dbo.RefTbl_Calendar.YYYYWK, CASE WHEN LEFT([itemcatid], 1) = '2' THEN 'MD' ELSE 'FP' END AS STATUS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwDailyUpdDailyReverseShipSlct_Trans', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vwDailyUpdDailyReverseShipSlct_Trans', NULL, NULL
GO
