...
SELECT        vwDailyUpdSlct_DailyOrder.Status, vwDailyUpdSlct_DailyOrder.Item_Date AS Date, MkTbl_SKUMaster.CAT_DESCRIPTION AS Department, MkTbl_SKUMaster.SUBCAT_DESCRIPTION AS Class, 
                         SUM(vwDailyUpdSlct_DailyOrder.Dmnd_Units) AS Dmnd_Units, SUM(vwDailyUpdSlct_DailyOrder.Dmnd_Cost$) AS Dmnd_Cost$, SUM(vwDailyUpdSlct_DailyOrder.Dmnd_Net$) AS Dmnd_Net$, 
                         SUM(vwDailyUpdSlct_DailyOrder.Dmnd_Gross$) AS Dmnd_Gross$, vwDailyUpdSlct_DailyOrder.Ord_Fiscal_Wk, vwDailyUpdSlct_DailyOrder.Ord_Fiscal_Month#, vwDailyUpdSlct_DailyOrder.Ord_Fiscal_Month, 
